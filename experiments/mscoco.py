...
# find corresponding captions, there are multiple captions per image
captions = []
...
clip_2 = CLIPWrapper(captions_different, images, similarity_measure) # here, images is just a placeholder, and not used
