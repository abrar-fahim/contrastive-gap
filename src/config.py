...
training_hyperparameters = {
    ...
    'loss_file_name_template': 'Ttemp_loss_seed_trainmode_captionencoder_dim_val_bsize_dataset_vmodel_pretrained_FINAL10', # can have name, temp, iweight, tweight, loss as of now,
