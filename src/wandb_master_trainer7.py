...
config.config_cuda_device = 'cuda:5' 
...
if __name__ == "__main__":
    ...
    sweep_configuration = {
        ...
        "name": "LR TUNE RUN from pretrained CLIP (finetuning CLIP backbone), VIT/B-32, CLIP + AU no weights  loss batch_size=64 256D, full MSCOCO, val as val, 0.01T",
