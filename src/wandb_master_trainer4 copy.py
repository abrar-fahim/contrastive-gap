...
if __name__ == "__main__":
    ...
    sweep_configuration = {
        ...
        "name": "CYCLIP run from pretrained CLIP (finetuning CLIP backbone), VIT/B-16, align+uniform+cross_uniformity-contrastive loss 512D, 64b, full MSCOCO, val as val, 0.01T",
