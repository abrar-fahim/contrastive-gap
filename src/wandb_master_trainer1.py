...
if __name__ == "__main__":
    ...
    sweep_configuration = {
        ...
        "name": "LR TUNE RUN from pretrained CLIP (finetuning CLIP backbone), VIT/B-32, CLIP+U batch_size=64 SWEEPING Ds, full MSCOCO, val as val, 0.01T",
        ...
        "parameters": {
            ...
            # TRAINING STUFF
            'clip_projection_dim': {'values': [32, 64, 128]}, # 512
